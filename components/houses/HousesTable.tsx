  ...
  useEffect(() => {
    const fetchHouses = async () => {
      try {
        ...
        const houses = Array.isArray(response.data.items) ? response.data.items : [];
        setHouseList(houses);
      } catch (err) {
        ...
        <Table>
          ...
          <TableHeader>
            <TableRow>
              ...
              <TableHead className='hidden md:table-cell'>Zone ID</TableHead>
          ...
          <TableBody>
            {filteredHouses.map((house) => (
              <TableRow key={house.id}>
                ...
                <TableCell className='hidden md:table-cell'>{house.address}</TableCell>
                <TableCell className='hidden md:table-cell'>{house.zoneId}</TableCell>
                <TableCell>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Are you sure you want to delete this house - {house.houseName}?</AlertDialogTitle>
                        <AlertDialogDescription>
                          This action cannot be undone. This will remove the house from your list!
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                        <AlertDialogAction onClick={() => handleDeleteHouse(house)}>Confirm</AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
                  </AlertDialog>
                </TableCell>
