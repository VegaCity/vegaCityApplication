...
import { AdminChartByDateOther } from "@/components/dashboard/_components/_Admin/AdminChartByDateOther";
      ...
      return (
        <div className="grid grid-cols-12 gap-3">
          <div className="col-span-4 md:col-span-8">
            {userRole && userRole === "Admin" && saleType === "FeeChargeCreate" ? (
              <AdminChartByDateOther params={{ saleType, startDate, endDate }} />
            ) : (
