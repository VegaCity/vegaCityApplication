...
export function CashierChartByDateOther({ params }: ChartByDateProps) {
  ...
  // const chartMapping = {
  //   totalAmountOrder: "totalOrder",
  //   totalAmountCashOrder: "totalOrderCash",
  //   totalAmountOrderOnlineMethod: "totalOrderOnlineMethods",
  // };
  ...
  //     label: "totalOrderCash",
  //     color: "hsl(var(--chart-3))",
  //   },
  //   totalAmountOrderOnlineMethod: {
  //     label: "totalOrderOnlineMethods",
  //     color: "hsl(var(--chart-3))",
  //   },
  // };
