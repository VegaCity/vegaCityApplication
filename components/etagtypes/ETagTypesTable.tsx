          ...
          <TableBody>
            {filteredEtagTypes.map((etag, i) => (
              <TableRow key={etag.id}>
                ...
                <TableCell className='hidden md:table-cell'>{etag.imageUrl}</TableCell>
                <TableCell className='hidden md:table-cell'>{etag.bonusRate}</TableCell>
                ...
                <TableCell>
                  <Link href={`/admin/etagtypes/edit/${etag.id}`}>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>Are sure for delete this -{etag?.name}- Etag Type?</AlertDialogTitle>
                          <AlertDialogDescription>
                            This action cannot be undone. This will deflag Etag in your Etag list!
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
                          <AlertDialogAction onClick={() => handleDeleteEtagType(etag)}>Confirm</AlertDialogAction>
                        </AlertDialogFooter>
                      </AlertDialogContent>
                    </AlertDialog>
                </TableCell>
