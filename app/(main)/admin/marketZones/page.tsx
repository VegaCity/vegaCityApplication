  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link href="/admin/marketZones/create" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
          Create MarketZone
        </Link>
      </div>
      <PackageTable />
...
export default MarketZonesPage;
