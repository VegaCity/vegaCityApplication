...
//       await ETagServices.editInfoEtag(params.id, {
//         phoneNumber,
//         gender,
//         birthday,
//       });
...
//       setIsLoading(true);
//       try {
//         const response = await ETagServices.editInfoEtag(params.id, {
//           birthday,
//           gender,
//           phoneNumber,
//         });
...
//           if (etagData?.birthday && etagData?.birthday.length > 0) {
//             const etagTypeMapping =
//               etagData?.gender?.length > 0 ? etagData.gender[0] : undefined;
